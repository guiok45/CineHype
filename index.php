						...
						<nav id="navbar">
							<div class="main-menu stellarnav">
								<ul class="menu-list">
									...
									<li class="menu-item"><a href="novidades.php" class="nav-link">Novidades</a></li>
								</ul>
                    ...
                    ?>
						<div class="slider-item">
							<div class="banner-content">
								...
								<p><?=$filme['descricao']?></p>
								<div class="btn-wrap">
									<a href="filme.php?id=<?= $filme['id']; ?>" class="btn btn-outline-accent btn-accent-arrow">Ver mais<i
