							...
							<div class="main-menu stellarnav">
								<ul class="menu-list">
									...
									<li class="menu-item has-sub">
										...
										<ul>
											<li class="active"><a href="sobreNos_login.php">Sobre nós</a></li>
...
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d8044.6158493278335!2d-7.513037211849039!3d39.81412134172638!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xd3d5ea6bb2280e1%3A0x1c460157bc4b46c8!2sEscola%20Superior%20de%20Tecnologia%20-%20Instituto%20Polit%C3%A9cnico%20de%20Castelo%20Branco!5e1!3m2!1spt-PT!2spt!4v1768495313456!5m2!1spt-PT!2spt" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>						</div>
				...
				<div class="col-md-2">
					...
					<div class="footer-menu">
						...
						<ul class="menu-list">
							<li class="menu-item">
								<p>CineHype é um videoclube moderno pensado para todos os verdadeiros amantes de cinema. Aqui, a paixão pelos filmes ganha vida através de um sistema simples e prático de reserva de filmes, permitindo que os utilizadores escolham, reservem e desfrutem dos seus títulos favoritos de forma rápida e cómoda.
								</p>
							</li>
							<li class="menu-item">
								<p>CineHype — onde cada reserva é o início de uma grande história. 🎥✨
								</p>
							</li>
						</ul>
