...
$mensagem = "";
  $_SESSION['email'] = $_POST['idFilme'];
  $id = $_POST['idFilme'];
  $stmt = "SELECT * FROM filmes WHERE id=$id";
...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    $sql = "UPDATE filmes SET nome='$nome', descricao='$descricao',foto='$foto' WHERE id=$id";
      ...
      <div class="flex-1 h-full max-w-4xl mx-auto overflow-hidden bg-white rounded-lg shadow-xl dark:bg-gray-800">
        <div class="flex flex-col overflow-y-auto md:flex-row">
          ...
          <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
            <form action="adicionarFilme.php" method="GET" enctype="multipart/form-data">
            <div class="w-full">
              ...
              <label class="block mt-4 text-sm">
                ...
                <input
                  ...
                  value="<?=$filmes['nome']?>" name="nome" id="nome" required
