								...
								<ul class="menu-list">
									...
									<li class="menu-item has-sub">
										...
										<ul>
											...
											<li><a href="contactos_login.php">Contactos</a></li>
											<li><a href="filmes_login.php">Filmes</a></li>
										</ul>

									</li>
									<li class="menu-item"><a href="novidades_login.php" class="nav-link">Novidades</a></li>
								</ul>
					...
					<?php
                      ...
                      if($total > 0) {
                        // inicia o loop que vai mostrar todos os dados
                         while($filme = $result1->fetch_assoc()){
                    ?>
						<div class="slider-item">
							<div class="banner-content">
								<h2 class="banner-title"><?=$filme['nome']?></h2>
								<p><?=$filme['descricao']?></p>
								<div class="btn-wrap">
									<a href="filme_login.php?id=<?= $filme['id']; ?>" class="btn btn-outline-accent btn-accent-arrow">Ver mais<i
											class="icon icon-ns-arrow-right"></i></a>
								</div>
							</div><!--banner-content-->
							<img src="admin/assets/imgFilme/<?=$filme['foto']?>" alt="banner" class="banner-image">
						</div><!--slider-item-->
					<?php
			...
			<div class="row">
				<div class="col-md-12">
					...
					<?php
                      ...
                      if($total > 0) {
                        // inicia o loop que vai mostrar todos os dados
                         while($filme = $result2->fetch_assoc()){
                    ?>

							<div class="col-md-3">
								<div class="product-item">
									<a href="filme_login.php?id=<?= $filme['id']; ?>">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="btn-wrap align-right">
						<a href="novidades.php" class="btn-accent-arrow">Ver todos <i
								class="icon icon-ns-arrow-right"></i></a>
					</div>
